...
public class CustomItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration())//1000
    ...
    /**
     * 添加动画，删除动画，稍微有点不同，需要在animateAdd
     * @param holder
     * @return
     */
    @Override
    public boolean animateAdd(final ViewHolder holder) {
        ...
        ViewCompat.setRotation(holder.itemView, 0);//旋转开始， 旋转0度开始
    ...
    void animateAddImpl(final ViewHolder holder) {
        ...
        ////////////////////////////////////////////////////////////////////
        animation.rotation(360).setDuration(getAddDuration()).
                setListener(new VpaListenerAdapter() {
                    @Override
                    public void onAnimationStart(View view) {
                        dispatchAddStarting(holder);
                    ...
                    @Override
                    public void onAnimationCancel(View view) {
                        ViewCompat.setRotation(view, 360);
                    }
